...
class ApplicationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    createApplicationApiV1AppPost(applicationIn, getIfExists, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (applicationIn === null || applicationIn === undefined) {
                throw new baseapi_1.RequiredError('Required parameter applicationIn was null or undefined when calling createApplicationApiV1AppPost.');
            }
    ...
    deleteApplicationApiV1AppAppIdDelete(appId, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling deleteApplicationApiV1AppAppIdDelete.');
            }
    ...
    getAppStatsApiV1AppAppIdStatsGet(appId, since, until, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling getAppStatsApiV1AppAppIdStatsGet.');
            }
            if (since === null || since === undefined) {
                throw new baseapi_1.RequiredError('Required parameter since was null or undefined when calling getAppStatsApiV1AppAppIdStatsGet.');
            }
            if (until === null || until === undefined) {
                throw new baseapi_1.RequiredError('Required parameter until was null or undefined when calling getAppStatsApiV1AppAppIdStatsGet.');
            }
    ...
    getApplicationApiV1AppAppIdGet(appId, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling getApplicationApiV1AppAppIdGet.');
            }
            const localVarPath = '/api/v1/app/{app_id}/'
                .replace('{' + 'app_id' + '}', encodeURIComponent(String(appId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    updateApplicationApiV1AppAppIdPut(appId, applicationIn, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling updateApplicationApiV1AppAppIdPut.');
            }
            if (applicationIn === null || applicationIn === undefined) {
                throw new baseapi_1.RequiredError('Required parameter applicationIn was null or undefined when calling updateApplicationApiV1AppAppIdPut.');
            }
            const localVarPath = '/api/v1/app/{app_id}/'
                .replace('{' + 'app_id' + '}', encodeURIComponent(String(appId)));
...
class ApplicationApiResponseProcessor {
    createApplicationApiV1AppPost(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteApplicationApiV1AppAppIdDelete(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    getAppStatsApiV1AppAppIdStatsGet(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
    ...
    getApplicationApiV1AppAppIdGet(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ApplicationOut", "");
    ...
    listApplicationsApiV1AppGet(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
    ...
    updateApplicationApiV1AppAppIdPut(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ApplicationOut", "");
