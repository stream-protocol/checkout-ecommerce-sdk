...
class Authentication {
    ...
    dashboardAccess(appId, options) {
        return this.api.getDashboardAccessApiV1AuthDashboardAccessAppIdPost(Object.assign({ appId }, options));
    }
    logout(options) {
        return this.api.logoutApiV1AuthLogoutPost(Object.assign({}, options));
    }
}
class Application {
    constructor(config) {
    ...
    create(applicationIn, options) {
        return this.api.createApplicationApiV1AppPost(Object.assign({ applicationIn }, options));
    }
    getOrCreate(applicationIn, options) {
        return this.api.createApplicationApiV1AppPost(Object.assign(Object.assign({ applicationIn }, options), { getIfExists: true }));
    }
    get(appId) {
...
class Endpoint {
    ...
    create(appId, endpointIn, options) {
        return this.api.createEndpointApiV1AppAppIdEndpointPost(Object.assign({ appId,
            endpointIn }, options));
    }
    ...
    rotateSecret(appId, endpointId, endpointSecretRotateIn, options) {
        return this.api.rotateEndpointSecretApiV1AppAppIdEndpointEndpointIdSecretRotatePost(Object.assign({ endpointId,
            appId,
            endpointSecretRotateIn }, options));
    }
    recover(appId, endpointId, recoverIn, options) {
        return this.api
            .recoverFailedWebhooksApiV1AppAppIdEndpointEndpointIdRecoverPost(Object.assign({ appId,
            endpointId,
            recoverIn }, options))
            .then(() => Promise.resolve());
    }
    replay(appId, endpointId, replayIn, options) {
        return this.api.replayMissingWebhooksApiV1AppAppIdEndpointEndpointIdReplayMissingPost(Object.assign({ appId,
            endpointId,
            replayIn }, options))
            .then(() => Promise.resolve());
    }
...
class EventType {
    ...
    create(eventTypeIn, options) {
        return this.api.createEventTypeApiV1EventTypePost(Object.assign({ eventTypeIn }, options));
    }
...
class Integration {
    ...
    list(appId, options) {
        return this.api.listIntegrationsApiV1AppAppIdIntegrationGet(Object.assign({ appId }, options));
    }
    create(appId, integrationIn, options) {
        return this.api.createIntegrationApiV1AppAppIdIntegrationPost(Object.assign({ appId,
    ...
    rotateKey(appId, integId, options) {
        return this.api.rotateIntegrationKeyApiV1AppAppIdIntegrationIntegIdKeyRotatePost(Object.assign({ integId,
            appId }, options));
    }
}
class Message {
    ...
    create(appId, messageIn, options) {
        return this.api.createMessageApiV1AppAppIdMsgPost(Object.assign({ appId, messageIn }, options));
    }
    get(appId, msgId) {
...
class MessageAttempt {
    ...
    listByMsg(appId, msgId, options) {
        return this.api.listAttemptsByMsgApiV1AppAppIdAttemptMsgMsgIdGet(Object.assign({ appId,
            msgId }, options));
    }
    listByEndpoint(appId, endpointId, options) {
        return this.api.listAttemptsByEndpointApiV1AppAppIdAttemptEndpointEndpointIdGet(Object.assign({ appId,
            endpointId }, options));
    }
    ...
    resend(appId, msgId, endpointId, options) {
        return this.api.resendWebhookApiV1AppAppIdMsgMsgIdEndpointEndpointIdResendPost(Object.assign({ endpointId,
            msgId,
            appId }, options));
    }
