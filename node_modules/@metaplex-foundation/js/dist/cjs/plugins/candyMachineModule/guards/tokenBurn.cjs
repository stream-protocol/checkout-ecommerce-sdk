...
const tokenBurnGuardManifest = {
  name: 'tokenBurn',
  settingsBytes: 40,
  settingsSerializer: Serializer.mapSerializer(Serializer.createSerializerFromBeet(mplCandyGuard.tokenBurnBeet), settings => ({ ...settings,
...
exports.tokenBurnGuardManifest = tokenBurnGuardManifest;
//# sourceMappingURL=tokenBurn.cjs.map
