...
const updateCandyMachineCollectionBuilder = (metaplex, params, authority, payer, programs) => {
  ...
  const currentCollectionAddress = params.collection.currentCollectionAddress ?? (CandyMachine.isCandyMachine(params.candyMachine) ? params.candyMachine.collectionMintAddress : null);
...
const updateCandyGuardAuthorityBuilder = (metaplex, params, candyGuardAuthority, payer, programs) => {
  ...
  const candyGuardAddress = params.candyGuard ?? (CandyMachine.isCandyMachine(params.candyMachine) && params.candyMachine.candyGuard ? params.candyMachine.candyGuard.address : null);

  if (!candyGuardAddress) {
    throw onMissingInputError(['candyGuard']);
  }

  return TransactionBuilder.TransactionBuilder.make().add(metaplex.candyMachines().builders().updateCandyGuardAuthority({
