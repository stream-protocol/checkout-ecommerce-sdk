...
const CANDY_MACHINE_HIDDEN_SECTION = 8 + // discriminator
8 + // features
32 + // authority
32 + // mint authority
32 + // collection mint
...
const CANDY_GUARD_DATA = 8 + // discriminator
32 + // base
1 + // bump
32; // authority

exports.CANDY_GUARD_DATA = CANDY_GUARD_DATA;
exports.CANDY_GUARD_LABEL_SIZE = CANDY_GUARD_LABEL_SIZE;
exports.CANDY_MACHINE_HIDDEN_SECTION = CANDY_MACHINE_HIDDEN_SECTION;
