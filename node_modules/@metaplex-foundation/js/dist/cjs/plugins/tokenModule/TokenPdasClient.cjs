...
class TokenPdasClient {
  ...
  associatedTokenAccount({
    ...
    return Pda.Pda.find(associatedTokenProgram.address, [owner.toBuffer(), tokenProgram.address.toBuffer(), mint.toBuffer()]);
  }

}

exports.TokenPdasClient = TokenPdasClient;
//# sourceMappingURL=TokenPdasClient.cjs.map
