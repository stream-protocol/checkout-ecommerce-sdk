...
/** @group Errors */
class CandyMachineV2Error extends MetaplexError.MetaplexError {
  constructor(input) {
    super({ ...input,
...
class CandyMachineV2NotLiveError extends CandyMachineV2Error {
  constructor(goLiveDate, options) {
    super({
      ...
      solution: 'You need to wait until the Candy Machine is live to mint from it. ' + 'If this is your Candy Machine, use "metaplex.candyMachinesV2().update(...)" to set the live date. ' + 'Note that the authority of the Candy Machine can mint regardless of the live date.'
    });
  }
...
exports.CandyMachineV2AddItemConstraintsViolatedError = CandyMachineV2AddItemConstraintsViolatedError;
exports.CandyMachineV2BotTaxError = CandyMachineV2BotTaxError;
exports.CandyMachineV2CannotAddAmountError = CandyMachineV2CannotAddAmountError;
exports.CandyMachineV2EndedError = CandyMachineV2EndedError;
exports.CandyMachineV2Error = CandyMachineV2Error;
exports.CandyMachineV2IsEmptyError = CandyMachineV2IsEmptyError;
exports.CandyMachineV2IsFullError = CandyMachineV2IsFullError;
exports.CandyMachineV2NotLiveError = CandyMachineV2NotLiveError;
