...
var gpaBuilders = require('../../tokenModule/gpaBuilders.cjs');
...
const findNftsByOwnerOperationHandler = {
  handle: async (operation, metaplex, scope) => {
    ...
    const mints = await new gpaBuilders.TokenGpaBuilder(metaplex, tokenProgram.address).selectMint().whereOwner(owner).whereAmount(1).getDataAsPublicKeys();
