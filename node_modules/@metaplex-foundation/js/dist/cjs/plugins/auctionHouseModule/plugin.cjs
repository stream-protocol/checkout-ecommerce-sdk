...
const auctionHouseModule = () => ({
  install(metaplex) {
    ...
    op.register(findBids.findBidsOperation, findBids.findBidsOperationHandler);
    ...
    op.register(findListings.findListingsOperation, findListings.findListingsOperationHandler);
    ...
    op.register(findPurchases.findPurchasesOperation, findPurchases.findPurchasesOperationHandler);
