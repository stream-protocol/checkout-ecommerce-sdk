...
const findCandyMachineV2CreatorPda = (candyMachine, programId = CandyMachineV2Program.publicKey) => {
  return Pda.find(programId, [Buffer.from('candy_machine', 'utf8'), candyMachine.toBuffer()]);
};
/** @group Pdas */

const findCandyMachineV2CollectionPda = (candyMachine, programId = CandyMachineV2Program.publicKey) => {
