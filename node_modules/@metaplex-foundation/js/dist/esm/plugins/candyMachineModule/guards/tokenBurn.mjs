import { tokenBurnBeet } from '@metaplex-foundation/mpl-candy-guard';
...
/** @internal */
const tokenBurnGuardManifest = {
  name: 'tokenBurn',
  settingsBytes: 40,
  settingsSerializer: mapSerializer(createSerializerFromBeet(tokenBurnBeet), settings => ({ ...settings,
...
export { tokenBurnGuardManifest };
//# sourceMappingURL=tokenBurn.mjs.map
