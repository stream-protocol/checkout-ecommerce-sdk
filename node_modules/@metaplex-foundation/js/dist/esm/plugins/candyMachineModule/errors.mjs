...
class GuardGroupLabelTooLongError extends CandyMachineV3Error {
  constructor(label, maxLength, options) {
    super({
      options,
      key: 'guard_group_label_too_long',
      title: 'Guard Group Label Too Long',
      problem: `The provided group label [${label}] is too long. ` + `Group labels cannot be longer than ${maxLength} characters.`,
...
class UnrecognizePathForRouteInstructionError extends CandyMachineV3Error {
  constructor(guard, path, options) {
    super({
      options,
...
class MintOwnerMustBeMintPayerError extends CandyMachineV3Error {
  constructor(guard, options) {
    super({
      ...
      solution: 'Please remove the `owner` attribute from the mint input so they can be the same.'
    });
  }
