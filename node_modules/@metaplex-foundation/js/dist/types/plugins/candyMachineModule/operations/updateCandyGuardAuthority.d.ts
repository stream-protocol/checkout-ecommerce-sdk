 ...
 * @category Types
 */
export declare type UpdateCandyGuardAuthorityOperation = Operation<typeof Key, UpdateCandyGuardAuthorityInput, UpdateCandyGuardAuthorityOutput>;
/**
 * @group Operations
 * @category Inputs
 */
export declare type UpdateCandyGuardAuthorityInput = {
 ...
 * @category Outputs
 */
export declare type UpdateCandyGuardAuthorityOutput = {
 ...
 * @category Inputs
 */
export declare type UpdateCandyGuardAuthorityBuilderParams = Omit<UpdateCandyGuardAuthorityInput, 'confirmOptions'> & {
