 ...
 * @category Types
 */
export declare type FindBidsOperation = Operation<typeof Key, FindBidsInput, FindBidsOutput>;
/**
 * @group Operations
 * @category Inputs
 */
export declare type FindBidsInput = {
 ...
 * @category Outputs
 */
export declare type FindBidsOutput = (LazyBid | Bid)[];
/**
 * @group Operations
 * @category Handlers
 */
