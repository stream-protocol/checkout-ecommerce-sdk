 ...
 * @category Types
 */
export declare type FindListingsOperation = Operation<typeof Key, FindListingsInput, FindListingsOutput>;
/**
 * @group Operations
 * @category Inputs
 */
export declare type FindListingsInput = {
 ...
 * @category Outputs
 */
export declare type FindListingsOutput = (Listing | LazyListing)[];
/**
 * @group Operations
 * @category Handlers
 */
