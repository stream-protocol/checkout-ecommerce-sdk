 ...
 */
export declare const findPurchasesOperation: import("../../../types").OperationConstructor<FindPurchasesOperation, "FindPurchasesOperation", FindPurchasesInput, FindPurchasesOutput>;
/**
 * @group Operations
 * @category Types
 */
export declare type FindPurchasesOperation = Operation<typeof Key, FindPurchasesInput, FindPurchasesOutput>;
/**
 * @group Operations
 * @category Inputs
 */
export declare type FindPurchasesInput = {
 ...
 * @category Outputs
 */
export declare type FindPurchasesOutput = (Purchase | LazyPurchase)[];
/**
 * @group Operations
 * @category Handlers
 */
