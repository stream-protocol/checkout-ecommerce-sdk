 ...
 * right to left.
 */
export declare const serializeFeatureFlags: (features: FeatureFlags, byteSize?: number | undefined, backward?: boolean) => Buffer;
/**
 ...
 */
export declare const deserializeFeatureFlags: (buffer: Buffer, numberOfFlags?: number | undefined, backward?: boolean) => FeatureFlags;
